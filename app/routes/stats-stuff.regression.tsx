...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Stats Stuff | Linear Regression" },
            ...
            <Card className="bg-[var(--color-accent-blue)] border-none">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                ...
                <div>
                  ...
                  <div className="text-xs text-[var(--color-ink-light)]">Intercept (a)</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-[var(--color-ink)]">
                    {formatNum(result.value.r)}
                  </div>
                  <div className="text-xs text-[var(--color-ink-light)]">r (correlation)</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-[var(--color-ink)]">
